    ...
    <div class="bg-body-light">
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-grow-1 fs-3 fw-semibold my-2 my-sm-3">Edit Leagues </h1>
    ...
    <div class="content">
        ...
        <div class="block block-rounded">
            ...
            <div class="block-content">
                <div class="row push">
                    <div class="col-lg-8">
                        <form action="{{route('leauge.update',$editLeague->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="mb-4">
                                <label class="form-label" for="example-text-input">League Name <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="val-name" name="name"  value="{{$editLeague->name}}" placeholder="League Name">
                                @error('name')
                            ...
                            <div class="mb-4">
                                ...
                                <input type="date" class="form-control" id="val-start_year" name="start_year" value="{{$editLeague->start_year}}" placeholder="League Year">
                                @error('start_year')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-4">
                                ...
                                <input type="date" class="form-control" id="val-date" name="year_ending"  value="{{$editLeague->year_ending}}" placeholder="League Ending Year">
                                @error('start_year')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control" id="val-format" name="format" value="{{$editLeague->format}}" placeholder="League Format">
                                @error('format')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div>
                                    <img src="{{ $editLeague->logo }}" alt="Old Image" style="max-width: 200px; max-height: 200px;">
                                </div>
