        ...
        <div class="content-side content-side-full">
          <ul class="nav-main">
            <li class="nav-main-item">
              ...
              <li class="nav-main-heading">News Category</li>
              ...
              <li class="nav-main-item{{ request()->is('pages/*') ? ' open' : '' }}">
                  ...
                  <ul class="nav-main-submenu">
                      <li class="nav-main-item">
                          <a class="nav-main-link{{ request()->is('pages/datatables') ? ' active' : '' }}" href="{{route('news-category.create')}}">
                              <span class="nav-main-link-name">Create NewsCategory</span>
                          </a>
                      </li>
                      <li class="nav-main-item">
                          <a class="nav-main-link{{ request()->is('pages/slick') ? ' active' : '' }}" href="{{route('news-category.index')}}">
                              <span class="nav-main-link-name">View News Category</span>
                          </a>
                      </li>
                      <li class="nav-main-item">
              ...
              <li class="nav-main-item{{ request()->is('News/*') ? ' open' : '' }}">
                  <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="true" href="#">
                      <i class="nav-main-link-icon fa fa-lightbulb"></i>
                  ...
                  <ul class="nav-main-submenu">
                      <li class="nav-main-item">
                          <a class="nav-main-link{{ request()->is('pages/datatables') ? ' active' : '' }}" href="{{route('news.create')}}">
                              <span class="nav-main-link-name">Create News</span>
                          </a>
                      </li>
                      <li class="nav-main-item">
      ...
      <div class="content py-0">
        <div class="row fs-sm">
          <div class="col-sm-6 order-sm-2 mb-1 mb-sm-0 text-center text-sm-end">
            Powered  with <i class="fa fa-heart text-danger"></i> by <a class="fw-semibold" href="https://1.envato.market/ydb" target="_blank">Virtual IT solutions</a>
          </div>
          <div class="col-sm-6 order-sm-1 text-center text-sm-start">
            <a class="fw-semibold" href="https://1.envato.market/r6y" target="_blank">Bhakundo</a> &copy;
